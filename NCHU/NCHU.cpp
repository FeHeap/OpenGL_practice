...
#define DrawTriangle(X) drawTriangle(X, sizeof(X) / sizeof(X[0]))
#define WIDTH 1920.0
...
private:
	float origin[2];
	void drawTriangle(int(*data)[3][2], int size) {
		float bufxy[2] = { 0.0, 0.0 };
		for (int i = 0; i < size; i++) {
			glBegin(GL_TRIANGLES);
				for (int j = 0; j < 3; j++) {
					bufxy[0] = (data[i][j][0] - origin[0]) / origin[0];
					bufxy[1] = (origin[1] - data[i][j][1]) / origin[1];
					glVertex2fv(bufxy);
				}
			glEnd();
		}
	...
	int Chung[28][3][2] = {
		// C
		// h
		{{704, 695}, {699, 695}, {699, 763},},
		{{704, 695}, {699, 763}, {704, 763},},
		{{704, 733}, {710, 717}, {704, 724},},
		{{710, 717}, {708, 723}, {714, 720},},
		{{710, 717}, {714, 720}, {718, 716},},
		{{718, 716}, {714, 720}, {721, 719},},
		{{718, 716}, {721, 719}, {725, 715},},
		{{725, 715}, {721, 719}, {728, 722},},
		{{725, 715}, {728, 722}, {734, 719},},
		{{734, 719}, {728, 722}, {731, 725},},
		{{734, 719}, {731, 725}, {737, 725},},
		{{737, 725}, {731, 725}, {731, 763},},
		{{737, 725}, {731, 763}, {737, 763},},
		// u
		{{799, 763}, {806, 763}, {799, 715},},
		{{799, 715}, {806, 763}, {806, 715},},
		// n
		{{827, 716}, {822, 716}, {822, 763},},
		{{827, 716}, {822, 763}, {827, 763},},
		{{827, 733}, {833, 717}, {827, 724},},
		{{833, 717}, {831, 723}, {837, 720},},
		{{833, 717}, {837, 720}, {841, 716},},
		{{841, 716}, {837, 720}, {844, 719},},
		{{841, 716}, {844, 719}, {848, 715},},
		{{848, 715}, {844, 719}, {851, 722},},
		{{848, 715}, {851, 722}, {857, 719},},
		{{857, 719}, {851, 722}, {854, 725},},
		{{857, 719}, {854, 725}, {860, 725},},
		{{860, 725}, {854, 725}, {854, 763},},
		{{860, 725}, {854, 763}, {860, 763},},
		// g
	};
	// Hsing
	int Hsing[23][3][2] = {
		...
		// n
		{{1130, 716}, {1125, 716}, {1125, 763},},
		{{1130, 716}, {1125, 763}, {1130, 763},},
		{{1130, 733}, {1136, 717}, {1130, 724},},
		{{1136, 717}, {1134, 723}, {1140, 720},},
		{{1136, 717}, {1140, 720}, {1144, 716},},
		{{1144, 716}, {1140, 720}, {1147, 719},},
		{{1144, 716}, {1147, 719}, {1151, 715},},
		{{1151, 715}, {1147, 719}, {1154, 722},},
		{{1151, 715}, {1154, 722}, {1160, 719},},
		{{1160, 719}, {1154, 722}, {1157, 725},},
		{{1160, 719}, {1157, 725}, {1163, 725},},
		{{1163, 725}, {1157, 725}, {1157, 763},},
		{{1163, 725}, {1157, 763}, {1163, 763},},

		// g
	};
	// University
	int University[78][3][2] = {
		// U
		// n
		{{1349, 716}, {1344, 716}, {1344, 763},},
		{{1349, 716}, {1344, 763}, {1349, 763},},
		{{1349, 733}, {1355, 717}, {1349, 724},},
		{{1355, 717}, {1353, 723}, {1359, 720},},
		{{1355, 717}, {1359, 720}, {1363, 716},},
		{{1363, 716}, {1359, 720}, {1366, 719},},
		{{1363, 716}, {1366, 719}, {1370, 715},},
		{{1370, 715}, {1366, 719}, {1373, 722},},
		{{1370, 715}, {1373, 722}, {1379, 719},},
		{{1379, 719}, {1373, 722}, {1376, 725},},
		{{1379, 719}, {1376, 725}, {1382, 725},},
		{{1382, 725}, {1376, 725}, {1376, 763},},
		{{1382, 725}, {1376, 763}, {1382, 763},},
		// i
		...
		// y
		{{1703, 715}, {1696, 715}, {1714, 763},},
		{{1703, 715}, {1714, 763}, {1721, 763},},
		{{1714, 763}, {1721, 763}, {1731, 715},},
		{{1731, 715}, {1721, 763}, {1738, 715},},
	};

public:
	NchuEn(float width, float height) {
		origin[0] = width / 2;
		origin[1] = height / 2;
	}
	void display_en() {
		glColor3f(0.007, 0.4375, 0.589);
		DrawTriangle(National);
		DrawTriangle(Chung);
		DrawTriangle(Hsing);
		DrawTriangle(University);
	}
};

void Display(void) {
	NchuCh word_ch(WIDTH, HEIGHT);
	NchuEn word_en(WIDTH, HEIGHT);
