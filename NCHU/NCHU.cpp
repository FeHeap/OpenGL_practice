...
private:
	...
	void polygon_xyConverse(float(*data)[2], int size) {
		for (int i = 0; i < size; i++) {
			data[i][0] = (data[i][0] - origin[0]) / origin[0];
			data[i][1] = (origin[1] - data[i][1]) / origin[1];
		}
	}
...
private:
	...
	void triangles_xyConverse(float(*data)[3][2], int size) {
		for (int i = 0; i < size; i++) {
			for (int j = 0; j < 3; j++) {
				data[i][j][0] = (data[i][j][0] - origin[0]) / origin[0];
				data[i][j][1] = (origin[1] - data[i][j][1]) / origin[1];
			}
		}
	}
